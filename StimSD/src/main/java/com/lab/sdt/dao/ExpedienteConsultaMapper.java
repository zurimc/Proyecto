...
public interface ExpedienteConsultaMapper {
	 ...
	 * @mbg.generated  Thu Jul 25 13:18:11 CDT 2019
	 */
	int updateByExampleSelective(@Param("record") ExpedienteConsulta record,
			@Param("example") ExpedienteConsultaExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table expediente_consulta
	 * @mbg.generated  Thu Jul 25 13:18:11 CDT 2019
	 */
	int updateByExample(@Param("record") ExpedienteConsulta record,
			@Param("example") ExpedienteConsultaExample example);
